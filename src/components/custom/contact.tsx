        ...
        <h1 className={`text-5xl pb-3 font-bold text-center  text-[#FFFD8F] dark:text-white text-shadow-lg ${titan.className}`}>Contact us</h1>
          <div
            ...
            <h2 className={`text-2xl font-bold text-[#FFFD8F] dark:text-white ${titan.className} `}>Get In Touch</h2>
              ...
              <ul className="mt-4 flex flex-wrap justify-center gap-6">
                <li className="flex items-center">
                  ...
                  <a href="mailto:gobindrai@gmail.com" className="text-sm ml-3">
                    <span className="font-medium">gobindrai@gmail.com</span>
                  </a>
                </li>
                <li className="flex items-center ">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='currentColor'
                  ...
                  <a href="tel:+911234567890" className="text-sm ml-3">
                    <span className="font-medium">88729-06032</span>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className="z-10 relative h-full max-lg:min-h-[350px]">
              ...
              <iframe src="https://www.google.com/maps?q=30.859290,74.941009&z=15&output=embed"
